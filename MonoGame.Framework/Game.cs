...
namespace Microsoft.Xna.Framework
{
    public class Game : IDisposable
    {
        ...
        static void Game_DrawAction (IDrawable drawable, GameTime gameTime)
        {
            drawable.Draw (gameTime);
        }
        private static Action<IDrawable, GameTime> DrawAction =Game_DrawAction;
        ...
        static void Game_UpdateAction (IUpdateable updateable, GameTime gameTime)
        {
            updateable.Update (gameTime);
        }
        private static Action<IUpdateable, GameTime> UpdateAction =
            Game_UpdateAction;
